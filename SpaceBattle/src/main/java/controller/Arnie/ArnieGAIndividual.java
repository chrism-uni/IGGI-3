 ...
 * Date: 17/10/12
 */
public class ArnieGAIndividual
{
    ...
    public ArnieSearch search;

    public ArnieGAIndividual(int a_genomeLength, int playerID, ArnieSearch search)
    {
    ...
    public ArnieGAIndividual(int genome[], int playerID, ArnieSearch search)
    {
        m_genome = genome;
        m_fitness = 0;
        accumFit = new StatSummary();
     ...
     */
    public double evaluate(SimpleBattle gameState, ArnieGAIndividual opponent)
    {
    ...
    public ArnieGAIndividual copy()
    {
        ArnieGAIndividual gai = new ArnieGAIndividual(this.m_genome.length, this.playerID, this.search);

...
import controller.CurlyStraight.sampleRHEA.strategy.ICoevPairing;
import controller.CurlyStraight.sampleRHEA.strategy.ICrossover;
import controller.CurlyStraight.sampleRHEA.strategy.IMutation;
import controller.CurlyStraight.sampleRHEA.strategy.ISelection;
 ...
 * Date: 17/10/12
 */
public class CoevSearchCurlyStr extends Search {
    ...
    public static int NUM_INDIVIDUALS = 18; //icnreased num_indiv
     ...
     */
    public CoevSearchCurlyStr(ICrossover ic, IMutation im, ISelection is, ICoevPairing icp, Random rnd)
    {
        super(rnd);
        cross = ic;
        mut = im;
    ...
    public void init(SimpleBattle gameState, int _playerID)
    {
        ...
        for(int i = 0; i < NUM_INDIVIDUALS; ++i)
        {
            ...
            this.numEvals += 2*pair.getGroupSize(); //increased numb of evals twofold
        }
    ...
    public int run(SimpleBattle _m_currentGameState, ElapsedCpuTimer elapsedTimer)
    {
        ...
        while(remaining > 2*avgTimeTaken && remaining > remainingLimit)
        {
            ...
            for(i = 0; i < ELITISM; ++i) {
                ...
                this.numEvals += 2*pair.getGroupSize();
            }
            ...
            m_numGenerations+=2; //increase no of gen twofold
            numIters++;
